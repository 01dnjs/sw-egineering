...
def quiz_word1(root1, user_number, category_id_str):
    ...
    # Create db
    import pandas as pd
    from quiz_generation.short_answer_quiz import ShortAnswerEKQuizModel
    ...
    # Create model -> 문제 생성기
    model = ShortAnswerEKQuizModel(word_list_category)
